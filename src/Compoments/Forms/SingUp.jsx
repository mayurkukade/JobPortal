      ...
      <div className="bg-yellow-500 rounded-lg">
        ...
        <form action="" className="p-5">
          ...
          <input
            ...
            className="border-2 rounded-md  w-96  h-10 pl-2 md:ml-[65px]"
          />
          <br />
          <br />
          ...
          <input
            ...
            className="border-2 rounded-md  w-96 h-10 pl-2 "
          />
          <br />
          <br />
          ...
          <input
            ...
            className="border-2 rounded-md w-96 h-10 pl-2 ml-[70px]"
          />
          <br />
          <br />
          ...
          <input
            ...
            className="border-2 rounded-md  w-96 h-10 pl-2  ml-[40px]"
          />
          <br />
          <br />
          ...
          <label htmlFor="otp" className="md:mr-[75px]">
            OTP :-{" "}
          </label>
          ...
          <button
            type="submit"
            className="w-48 h-10 md:ml-[128px] mt-5  border-2 rounded-md bg-green-700"
          >
            SingUp
          </button>
        </form>
