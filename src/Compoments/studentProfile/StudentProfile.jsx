      ...
      <form onSubmit={handleSubmit}>
        ...
        {step2 && (
          <div className="bg-white p-5 rounded-md">
            ...
            <p className="text-lg mt-5">Highest Qualification</p>
            ...
            <p className="text-lg mt-5">Course</p>
            <div className="w-48">
              <Input type="search" label="Search" />
            </div>
            <p className="text-lg mt-5">Specialization</p>
            ...
            <p className="text-lg mt-5">University Institution</p>

            <div className="flex w-[12rem] h-[2rem] mt-2  items-center justify-center">
              <Input type="search" label="Univesity Institution" />
            </div>

            <p className="text-lg mt-5">Course Type</p>
            ...
            <div className="flex mt-5">
              <div className="w-auto h-[2rem]  flex  mr-2">
                <Input
                  type="date"
                  value={startdate1}
            ...
            <p className="text-lg mt-5">Key Skills</p>
        ...
        {step3 && (
          <div className="bg-white p-5 rounded-md">
            <p className="text-2xl">Resume Upload</p>
            <hr className="border-1 border-black" />
            ...
            <div className="flex flex-wrap mt-2">
              <Input type="search" label="Preffered work Location" />
            </div>
            ...
            <p className="text-lg mt-5">Gender </p>
