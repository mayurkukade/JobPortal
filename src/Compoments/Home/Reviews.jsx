...
const Review = styled.div`
  width: ${(props) => props.scale * 550}px;
  display: flex;
  padding: ${(props) => props.scale * 25}px;
  background: #fff;
  border-radius: 4px;
...
const Avatar = styled.div`
  border-radius: 50%;
  width: ${(props) => props.scale * 88}px;
  height: ${(props) => props.scale * 88}px;
  overflow: hidden;
  flex-shrink: 0;
...
const Content = styled.div`
  p {
    ...
    font-size: ${(props) => props.scale * 30}px;
    line-height: ${(props) => props.scale * 35}px;
    font-weight: 200;
    text-align: left;
