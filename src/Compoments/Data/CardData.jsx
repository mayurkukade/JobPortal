  ...
  },
  {
    ...
    desc: (
      <div className="flex flex-wrap">
        ...
        <Card
          variant="gradient"
          className="w-full max-w-[20rem] p-8 h-[590px]"
          color="gray"
        >
          <CardHeader
            floated={false}
          ...
          <CardBody className="p-0">
            <Typography>
              <p className="text-[1rem] text-black mb-5 font-Inter ">
                Every Company you need to boost your career
              </p>
            </Typography>
            <Typography>
              <p className="text-[1rem] text-black mb-2 font-Inter ">
                <b> Additional Perks :</b>
              </p>
            </Typography>
            <ul className="flex flex-col gap-4 mt-5">
              <li className="flex items-center gap-4">
                ...
                <Typography className="font-normal text-black text-[0.9rem]">
          ...
          <CardFooter className="mt-20 p-0">
            ...
            <Typography>
              <p className="text-[0.7rem] text-black mt-5">
        ...
        <Card
          variant="gradient"
          className="w-full max-w-[20rem] p-8 sm:ml-10 h-[590px] sm:mt-0 mt-5"
          color="gray"
        >
          <CardHeader
            floated={false}
          ...
          <CardBody className="p-0">
            ...
            <Typography className="flex justify-center ">
              ...
              <p className="text-black text-xs ml-2">INR 500/Month</p>
        ...
        <Card
          variant="gradient"
          className="w-full max-w-[20rem] p-8 h-[590px] sm:ml-10 sm:mt-0 mt-5"
          color="gray"
        >
          <CardHeader
            floated={false}
          ...
          <CardBody className="p-0">
            ...
            <Typography className="flex justify-center ">
              ...
              <p className="text-black text-xs ml-2">INR 1500/Month</p>
            ...
            <Typography className="flex justify-center mb-5">
              <p className="text-black text-xs ml-2">(50% OFF)</p>
            </Typography>
            <Typography>
              <p className="text-[1rem] text-black mb-2 font-Inter ">
                <b> Additional Perks :</b>
