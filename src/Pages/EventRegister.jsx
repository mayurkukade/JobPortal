    ...
    <div>
      ...
      <div className="mx-auto container p-5 bg-primary mb-10">
        <form className="m-5 sm:m-10" ref={form} onSubmit={sendEmail}>
            ...
            <div className="w-full sm:w-72">
              ...
              >
                ...
                <option value="bootcamp">
                  Upskilling Consultation for Students/Professionals
                </option>
                <option value="MS/MBA">
                  Company Start-Up Support for Students/Professionals
                </option>
                <option value="Hiring/Post JObs">
                  {" "}
                  Career Counselling with Parents for School Students (1-12)
                </option>
                <option value="Mentor">Mentor</option>
              </select>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-12 mb-5">
            <div className="w-full sm:w-72 mb-5 sm:mb-0">
              <p className="text-gray-200">linkedin profile</p>
              <Input className="text-white" name="linkedin_profile" required />
            </div>
